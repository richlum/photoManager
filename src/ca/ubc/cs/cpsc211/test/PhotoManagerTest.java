...
public class PhotoManagerTest {
	...
	@Test
	public void testRenameAlbum() throws PhotoAlreadyInAlbumException{
		aPhotoManager.addAlbum(album1);
		album1.addPhoto(photo4);
		album1.addPhoto(photo5);
		
		aPhotoManager.renameAlbum(album1.getName(), "wheee");
		Set<Album> theAlbums = aPhotoManager.getAlbums();
		for (Album album : theAlbums){
			System.out.println("album " + album.getName()	);
		}
		Set<Photo> thePhotos = aPhotoManager.getPhotos();
		for (Photo photo : thePhotos){
			System.out.println("photos" + photo.getName());
		}
